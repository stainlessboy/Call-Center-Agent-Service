...
MENU_LABELS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "electronic_queue": "🎫 Электронная очередь (скоро)",
        "weekend_days": "📅 Выходные дни (скоро)",
        # Rates submenu
        "rates_individuals": "👤 Курс физ.лиц",
        "rates_corporate": "🏢 Курс юр.лиц (скоро)",
        "rates_online": "🌐 Курс онлайн конверсии (скоро)",
        "rates_atm": "🏧 Курс банкоматов (скоро)",
    ...
    "en": {
        ...
        "electronic_queue": "🎫 Electronic queue (soon)",
        "weekend_days": "📅 Weekend hours (soon)",
        "rates_individuals": "👤 Individual rates",
        "rates_corporate": "🏢 Corporate rates (soon)",
        "rates_online": "🌐 Online conversion rates (soon)",
        "rates_atm": "🏧 ATM rates (soon)",
    ...
    "uz": {
        ...
        "electronic_queue": "🎫 Elektron navbat (tez orada)",
        "weekend_days": "📅 Dam olish kunlari (tez orada)",
        "rates_individuals": "👤 Jismoniy shaxslar kursi",
        "rates_corporate": "🏢 Yuridik shaxslar kursi (tez orada)",
        "rates_online": "🌐 Onlayn konversiya kursi (tez orada)",
        "rates_atm": "🏧 Bankomatlar kursi (tez orada)",
